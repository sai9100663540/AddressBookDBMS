...
values ('Saikumar', 890000.0, '2021-04-10');
insert into employee_payroll (name, salary, startDate)
values ('Sangeetha', 850000.0, '2021-09-10');
insert into employee_payroll (name, salary, startDate)
values ('Sumitra', 700000.0, '2021-02-10');
insert into employee_payroll (name, salary, startDate)
values ('Raju', 600000.0, '2021-05-10');

----- UC4 -----
select * from employee_payroll;

----- UC5 -----
select * from employee_payroll where id = 'Saikumar';
...
values ('Sony', 500000.0, '2021-01-10', 'Sales');
insert into employee_payroll
(name, basic_pay, startDate, gender, phone_number, department, deductions, taxable_pay, income_tax, net_pay)
values ('Sony', 500000.0, '2021-01-10', 'F', '456765', 'Marketing', 30000, 400, 756, 857);
...
values ('Sangeetha', 'F','989656565','Anu','2021-01-10');
insert into employee(name, gender, phone_number, address,startDate)
values ('Kiran', 'M','8686868686','Eshwar','2021-10-01');
insert into employee(name, gender, phone_number, address,startDate)
values ('Keerthana', 'F','9835464678','Srivani','2021-01-04');
insert into employee(name, gender, phone_number, address,startDate)
values ('Sweety', 'F','6464646445','Hyderabad','2021-04-10');
...
values ('Sony', 'F','888888885','India','2021-04-16', 3000000);
insert into employee(name, gender, phone_number, address,startDate, salary)
values ('Shruthi', 'F','453637475','Hyd','2021-04-17', 5000000);
...
insert into employee(name, gender, phone_number, address,startDate)
values ('Sony', 'F','9895689865','NY','2021-04-10');
insert into payroll(basic_pay, deductions, income_tax, taxable_pay, tax, net_pay,emp_ID)
